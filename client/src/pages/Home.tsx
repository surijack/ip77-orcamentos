...
function ProposalPreview({ items, quoteNumber, emissionDate, seller, customer, total, onPrint, onDownload }: { items: QuoteItem[]; quoteNumber: string; emissionDate: string; seller: SellerData; customer: CustomerData; total: string; onPrint: () => void; onDownload: () => void }) {
